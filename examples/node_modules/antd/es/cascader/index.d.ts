...
export interface ShowSearchType {
    ...
    render?: (inputValue: string, path: CascaderOptionType[], prefixCls: string | undefined, names: FilledFiledNamesType) => React.ReactNode;
...
export default class Cascader extends React.Component<CascaderProps, CascaderState> {
    ...
    flattenTree(options: CascaderOptionType[], changeOnSelect: boolean | undefined, filedNames: FiledNamesType | undefined, ancestor?: CascaderOptionType[]): CascaderOptionType[][];
