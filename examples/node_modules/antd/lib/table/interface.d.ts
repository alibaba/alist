...
export declare type TableSelectWay = 'onSelect' | 'onSelectAll' | 'onSelectInvert';
...
export interface TableProps<T> {
    ...
    onChange?: (pagination: PaginationConfig | boolean, filters: Record<keyof T, string[]>, sorter: SorterResult<T>) => void;
