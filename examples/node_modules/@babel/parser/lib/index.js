  ...
  _proto.parseDecorators = function parseDecorators(allowExport) {
    ...
    if (this.match(types._export)) {
      ...
      if (this.hasPlugin("decorators") && !this.getPluginOption("decorators", "decoratorsBeforeExport")) {
        this.raise(this.state.start, "Using the export keyword between a decorator and a class is not allowed. " + "Please use `export @dec class` instead, or set the " + "'decoratorsBeforeExport' option to true.");
      }
