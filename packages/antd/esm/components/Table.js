...
var RecursionTable = function (props) {
    ...
    var _c = useToggle(props), openRowKeys = _c.openRowKeys, toggle = _c.toggle, toggleAll = _c.toggleAll, toggleState = _c.toggleState;
    var expandProps = {};
    ...
    return React.createElement(ToggleContext.Provider, { value: { toggle: toggle, toggleAll: toggleAll, toggleState: toggleState, openRowKeys: openRowKeys } },
        React.createElement(Table, __assign({ dataSource: loopDataSource }, expandProps, others, { expandedRowKeys: openRowKeys })));
};
