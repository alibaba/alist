...
const InternalToggleTrigger = (props) => {
    const { id, render,
        ...
        children, hideIcon, color, fontSize, ...others
    } = props
    return <Toggle id={id}>
        {({ toggle, expandStatus }) => {
            ...
            return <Button type="primary" text {...others} onClick={toggle}>
...
// const ListToggleTrigger = createVirtualBox('alist-toggle-trigger', InternalToggleTrigger)
