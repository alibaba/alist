...
const getUmdConfig = require('./lib/webpack.umd');
const babelConfig = require('./lib/babelConfig');
const paths = require('./lib/paths');
const umdJson = require(paths.umd);
const umdConfig = getUmdConfig(umdJson);
...
async function run(basedir) {
    ...
    for (const file of files) {
        ...
        if (file.match(ES_PATTERN)) {
            ...
            content = content.replace(/@import ('|")~/g, "@import 'node_modules/");
